ContData.env$myThresh.Gross.Fail.Hi.WaterTemp = 10
ContData.env$myThresh.Gross.Fail.Lo.WaterTemp = -.5
ContData.env$myThresh.Gross.Suspect.Hi.WaterTemp = 6
ContData.env$myThresh.Gross.Suspect.Lo.WaterTemp = 3
ContData.env$myThresh.Spike.Hi.WaterTemp = 1
ContData.env$myThresh.Spike.Lo.WaterTemp = 0.5
ContData.env$myThresh.RoC.SD.number.WaterTemp = 1
ContData.env$myThresh.RoC.SD.period.WaterTemp = 12
