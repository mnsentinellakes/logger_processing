...
loggerchoices=list("Air Pressure"="AirBP","Air Temperature"="AirTemp","Chlorophyll A"="Chlorophylla","Conductivity"="Cond","Discharge"="Discharge","Dissolved Oxygen"="DO",
                   "Gage Height"="GageHeight","pH"="pH","Turbidity"="Turbidity","Water Pressure"="WaterP","Water Temperature"="WaterTemp")
